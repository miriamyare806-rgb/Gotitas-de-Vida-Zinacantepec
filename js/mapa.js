...
const defaultStyle = { color: '#0b66ff', weight: 2, fillOpacity: 0.05 };
const highlightStyle = { color: '#0b66ff', weight: 4, fillOpacity: 0.15 };
...
const zonas = [
  ...
  {
    nombre: "Parque de la Ciencia Sierra Morelos",
    coords: [19.3087, -99.7135],
    descripcion: "Área natural protegida ideal para caminatas, ciclismo y observación de fauna local.",
    tipo: "Parque"
  },
  {
